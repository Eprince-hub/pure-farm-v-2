...
export default function ProductScreen(props) {
  ...
  if (!product) {
    return <Box>Sorry, The Product Is Not Found</Box>;
  }
    ...
    <Layout title={product.name} description={product.description}>
      <section>
        <Box sx={classes.allPagesPadding}>
          ...
          <Grid container spacing={0} sx={classes.singleProductImageGrid}>
            <Grid item md={6} xs={12}>
              <Box sx={classes.singleProductImage}>
                <Image
                  src={product.image}
                  alt={product.name}
                  width={50}
          ...
          <div>
            <Typography component="h1" variant="h1" sx={classes.centerAligned}>
              Product Details
            </Typography>
