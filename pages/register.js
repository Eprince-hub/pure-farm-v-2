...
export default function Register() {
  ...
  return (
    <Layout title="Register" customLayoutClassName={classes.loginLayoutStyle}>
      <section>
        <Box sx={classes.loginPageStyle}>
          <Grid container spacing={1} sx={classes.loginGrid}>
            <Grid item md={6} xs={12}>
              <Box sx={classes.loginPageImage}>
                <span>
                  <Image
                    src={farmImage}
